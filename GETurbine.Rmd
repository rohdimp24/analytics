...
boxplot(turbineTrainData$X190,turbineTrainData$X189,names=c("X190","X189"))
...
#hist
hist(turbineTrainData$X189)

hist(turbineTrainData$X190)
...
plot(turbineTrainData$X189,turbineTrainData$X190)
...
skewness(turbineTrainData$X189)
