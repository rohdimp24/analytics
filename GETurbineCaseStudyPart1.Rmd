---
title: "GETurbineCaseStudy Part1 by Rohit Agarwal 305015992"
...
abline(a=1500,b=0,col="blue")
legend(1570,1570,c("Actual", "Fitted"), pch = c(1,1), col = c('grey','red'))
# Restore default clipping rect
par(mar=c(5, 4, 4, 2) + 0.1)


numHighValues<-nrow(subset(turbineTestData,turbineTestData$X190>1500))
percentHighValues<-numHighValues/nrow(turbineTestData)*100
percentHighValues

```

the model is now predicting 14.9% values not properly on the test data
